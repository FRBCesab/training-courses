...
Select _**Download R for Windows**_ `|` _**Base**_ `|` _**Download R 4.3.1 for Windows**_ 
...
- Install **`Rtools4.3`**<br/>
`r fontawesome::fa_i("link")`&nbsp; [https://cran.r-project.org/bin/windows/Rtools/rtools43/rtools.html](https://cran.r-project.org/bin/windows/Rtools/rtools43/rtools.html)

**`Rtools4.3`** is strongly recommended to install some `r fontawesome::fa_i("r-project")` packages 
...
`.deb` file for Ubuntu 22 (or Ubuntu 20/Debian 11 depending on your version) 
and install it. 
